...
<body>
      ...
      <div class="about__content">
        <div class="inner">
          ...
          <a href="https://apply.bigredhacks.com/" target=_blank class="is-bold">Interested in attending?
            Apply here!</a>
          <p>Applications close 9/3/21 at 5 PM Eastern Time</p>
        </div>
        <div class="inner">
      ...
      <div class="faq__container">
        ...
        <div class="inner">
          ...
          <div class="faq__single">
            ...
            <p class="answer">Unfortunately, we will not be able to have a hardware lab this year. However, hardware
              hacks will still be permitted, as long as you furnish your own equipment.</p>
          </div>
          <div class="faq__single">
          ...
          <div class="faq__single">
            ...
            <p class="answer">Send them to info@bigredhacks.com!</p>
          </div>
  ...
  <div id="footer">
    ...
    <div class="btn-social-group">
      ...
      <a class="btn btn-social" href="mailto: info@bigredhacks.com" target="_blank"><i class="fa fa-envelope"
          aria-hidden="true"></i></a>
